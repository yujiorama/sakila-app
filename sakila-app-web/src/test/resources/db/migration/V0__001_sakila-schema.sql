...
(
    ...
    KEY idx_fk_customer_store_id (store_id),
    KEY idx_fk_customer_address_id (address_id),
...
(
    ...
    KEY idx_fk_film_actor_film_id (`film_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
CREATE TRIGGER `ins_film`
    ...
    ON `film`
    FOR EACH ROW
    CALL "org.bitbucket.yujiorama.sakilaapp.test.h2.FilmInsertTrigger";
...
CREATE TRIGGER `upd_film`
    ...
    ON `film`
    FOR EACH ROW
    CALL "org.bitbucket.yujiorama.sakilaapp.test.h2.FilmUpdateTrigger";
...
CREATE TRIGGER `del_film`
    ...
    ON `film`
    FOR EACH ROW
    CALL "org.bitbucket.yujiorama.sakilaapp.test.h2.FilmDeleteTrigger";
...
(
    ...
    KEY idx_fk_inventory_film_id (film_id),
...
(
    ...
    KEY idx_fk_payment_staff_id (staff_id),
    KEY idx_fk_payment_customer_id (customer_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
(
    ...
    KEY idx_fk_rental_customer_id (customer_id),
    KEY idx_fk_rental_staff_id (staff_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
(
    ...
    KEY idx_fk_stuff_store_id (store_id),
    KEY idx_fk_stuff_address_id (address_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
(
    ...
    KEY idx_fk_stor_address_id (address_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
